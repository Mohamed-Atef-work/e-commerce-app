...
class SaveInitialDataUseCase
    extends BaseUseCase<bool, CachedUserDataModel> {
  ...
  Future<Either<Failure, bool>> call(CachedUserDataModel params) async {
    final userEither = await _sharedRepo.saveUserDataLocally(params);
    final passwordEither =
        await _sharedRepo.saveUserPasswordLocally(params.password);
