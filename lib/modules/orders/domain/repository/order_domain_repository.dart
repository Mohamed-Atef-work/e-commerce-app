...
abstract class OrderDomainRepo {
  Future<Either<Failure, void>> deleteItemFromOrder(DeleteItemFromOrderParams params);
  ...
  Future<Either<Failure, OrderDataEntity>> getOrderData(DocumentReference orderRef);
  Future<Either<Failure, List<ProductEntity>>> getOrderItems(DocumentReference orderRef);
  Future<Either<Failure, Stream<List<UserEntity>>>> streamUsersWhoOrdered();
  Future<Either<Failure, Stream<List<OrderDataEntity>>>> streamOfUserOrders(String userId);
